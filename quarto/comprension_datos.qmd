...
|----------------------|-----------------------------------------------------------------------|------------------|
| `idProductos`        | Identificador único asignado a cada producto en la base de datos.     | Numérico         |
...
| `Detalles precio`    | Rango de precios en el que el producto puede encontrarse.             | Texto            |
