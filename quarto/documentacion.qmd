...
```
  ...
  Una vez activado el entorno, puedes ejecutar una de las funciones dentro del script `pipeline.py`.
...
```
  ...
  Cada uno de estos comandos ejecuta la función indicada dentro de pipeline.py y va mostrando en la consola los mensajes de progreso correspondientes.
