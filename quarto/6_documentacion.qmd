...
```{mermaid}
flowchart TD
    A[(MongoDB<br/>message_backup)] -->|últimas 10 respuestas| B[fetch_last_messages]
...
╠══════════════════════════════════════════════════╣
║  Faithfulness         : 0.977 (peso: 40%)        ║
║  Answer Relevancy     : 0.975 (peso: 35%)        ║
║  Context Precision    : 0.933 (peso: 12%)        ║
║  Context Recall       : 0.950 (peso: 12%)        ║
╠══════════════════════════════════════════════════╣
║  ⭐ SCORE FINAL       : 0.977                    ║
╚══════════════════════════════════════════════════╝
```
